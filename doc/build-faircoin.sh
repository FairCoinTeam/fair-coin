...
# Clone sources
git clone git://github.com/FairCoinTeam/fair-coin.git faircoin
...
bin/gbuild ../faircoin/contrib/gitian-descriptors/boost-linux.yml
mv build/out/boost-*.zip inputs/

bin/gbuild ../faircoin/contrib/gitian-descriptors/deps-linux.yml
mv build/out/faircoin-deps-*.zip inputs/

bin/gbuild ../faircoin/contrib/gitian-descriptors/qt-linux.yml
mv build/out/qt-*.tar.gz inputs/

bin/gbuild ../faircoin/contrib/gitian-descriptors/boost-win.yml
mv build/out/boost-*.zip inputs/

bin/gbuild ../faircoin/contrib/gitian-descriptors/deps-win.yml
mv build/out/faircoin-deps-*.zip inputs/

bin/gbuild ../faircoin/contrib/gitian-descriptors/qt-win.yml
...
cd ..
git clone https://github.com/FairCoinTeam/gitian.sigs.git
