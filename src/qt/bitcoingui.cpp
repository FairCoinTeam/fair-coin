...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a FairCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/faircoin"), tr("&About FairCoin"), this);
    aboutAction->setToolTip(tr("Show information about FairCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for FairCoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/faircoin"), tr("&Show / Hide"), this);
    encryptWalletAction = new QAction(QIcon(":/icons/lock_closed"), tr("&Encrypt Wallet..."), this);
    encryptWalletAction->setToolTip(tr("Encrypt or decrypt wallet"));
    encryptWalletAction->setCheckable(true);
    unlockWalletAction = new QAction(QIcon(":/icons/lock_open"), tr("&Unlock wallet for minting..."), this);
    ...
    signMessageActionMenu = new QAction(QIcon(":/icons/edit_menu"), tr("Sign &message..."), this);
    ...
    connect(signMessageActionMenu, SIGNAL(triggered()), this, SLOT(gotoSignMessageTab()));
    connect(verifyMessageAction, SIGNAL(triggered()), this, SLOT(gotoVerifyMessageTab()));
    connect(verifyMessageActionMenu, SIGNAL(triggered()), this, SLOT(gotoVerifyMessageTab()));
}
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/faircoin_testnet"));
            setWindowIcon(QIcon(":icons/faircoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/faircoin_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("FairCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("FairCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FairCoin network", "", count));
}
...
{
    QString strMessage =
        tr("The mandatory transaction fee is %1. Do you want to pay the fee?").arg(
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid FairCoin address or malformed URI parameters."));
    }
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unencrypted:
        ...
        break;
    case WalletModel::UnlockedForMintingOnly:
    case WalletModel::Unlocked:
        labelEncryptionIcon->show();
        labelEncryptionIcon->setPixmap(QIcon(":/icons/golden_lock_open").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
        labelEncryptionIcon->setToolTip(status == WalletModel::UnlockedForMintingOnly ? tr("Wallet is <b>encrypted</b> and currently <b>unlocked for block minting only</b>") : tr("Wallet is <b>encrypted</b> and currently <b>unlocked</b>"));
...
void BitcoinGUI::setWalletLock(bool fUnlockForMintingOnly)
{
    if(!walletModel)
        return;
    // Unlock wallet when requested by wallet model
    if (walletModel->getEncryptionStatus() == WalletModel::Locked ||
       (walletModel->getEncryptionStatus() == WalletModel::UnlockedForMintingOnly && !fUnlockForMintingOnly))
    {
        AskPassphraseDialog dlg(fUnlockForMintingOnly ? AskPassphraseDialog::UnlockForMinting : AskPassphraseDialog::Unlock, this);
        dlg.setModel(walletModel);
        dlg.exec();
    }
